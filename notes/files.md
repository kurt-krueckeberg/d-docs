...
To uderstand how to use **std.file**, see [Working with files in the D programming language](http://nomad.uk.net/articles/working-with-files-in-the-d-programming-language.html), which has numerous code examples.
